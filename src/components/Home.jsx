    ...
    <>
      <div className="flex-container flex-column align-center">
        <div className="flex-container flex-column">
          <h1 className="heading-2">Current Score </h1>
          <div className="flex-container flex-gap">
            <h2 className="heading-3">CPU:{cpuScore}</h2>
            <h2 className="heading-3">Player:{playerScore}</h2>
          </div>
        </div>
        ...
        <div id="selector" onClick={handleClick}>
          {hideButton ? (
            <div id="button-container">
              <button onClick={handleCall} className="button">
                Call
              </button>
              <button onClick={handleFold} className="button">
                Fold
              </button>
            </div>
          ) : (
            <button onClick={nextRound} className="button">
              Next Round
            </button>
          )}
        </div>
        <div className="flex-container">
          {currentHand > 0 && <h1 className="winner-text">{winRound ? "You Won!" : "You Lost!"}</h1>}
        </div>
      </div>
    </>
  );
